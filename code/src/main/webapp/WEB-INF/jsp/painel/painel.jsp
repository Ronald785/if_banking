...
<head>
    ...
    <title>IF Banking - Reinventado seu futuro!</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion no-print" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:url value="painel"/>">
            ...
            <div class="sidebar-heading">
             ...
             <!-- Nav Item - DepÃ³sito -->
             <li class="nav-item">
                <a class="nav-link" href="<c:url value="deposito"/>">
                    <i class="fas fa-fw fa-money-check"></i>
                    <span>Depositar</span></a>
            </li>
             <!-- Nav Item - Saque -->
             <li class="nav-item">
                <a class="nav-link" href="<c:url value="saque"/>">
                    <i class="fas fa-fw fa-money-bill-wave"></i>
                    <span>Sacar</span></a>
            </li>
             <!-- Nav Item - TransferÃªncia -->
             <li class="nav-item">
                <a class="nav-link" href="<c:url value="transferencia"/>">
                    <i class="fas fa-fw fa-cube"></i>
                    <span>Transferir</span></a>
            </li>
             <!-- Nav Item - HistÃ³rico -->
             <li class="nav-item">
                <a class="nav-link" href="<c:url value="transacoes"/>">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">Todos os Alertas</a>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="img/if_icon.png"
                                            alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Sua conta foi criada com sucesso!</div>
                                        <div class="small text-gray-500">IF Banking</div>
                                    </div>
                                </a>
                                <a class="dropdown-item text-center small text-gray-500" href="#">Ler todas as notificações</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Lucas Santos Souza</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 only-print">
                        <h1 class="h3 mb-0 text-gray-800">Relatório Conta Bancária</h1>
                    </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Transações
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Variação do Saldo</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="#">Limpar</a>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Saques
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Transferências
                                        </span>
                                    </div>
                                </div>
                            </div>
